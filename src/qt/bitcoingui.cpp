...
{
    resize(850, 550);
    setWindowTitle(tr("ciccio") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a ciccio address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About ciccio"), this);
    aboutAction->setToolTip(tr("Show information about ciccio"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for ciccio"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("ciccio client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("ciccio client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ciccio network.", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid ciccio address or malformed URI parameters."));
    }
...
void BitcoinGUI::setStyle(const QString& fileName)
{
    ...
    {
        uiInterface.ThreadSafeMessageBox("Error loading style from file.", _("ciccio"), CClientUIInterface::OK | CClientUIInterface::ICON_ERROR | CClientUIInterface::MODAL);
    }
}
...
void BitcoinGUI::bountySendRequest()
{
    ...
    const QString url (QString("http://faucet.ciccio.net:666/ciccio/get/%1")

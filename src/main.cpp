...
int64 nChainStartTime = 1418126690;
...
const string strMessageMagic = "ciccio Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in ciccio
    bool fStrictPayToScriptHash = true; // Always active in ciccio
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ciccio", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Man dies after 35 found in container si";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0xee4415435fe1d0da4a27c35ce622f68f0a3f80fc91f59d57e8c3ade528141511"));
